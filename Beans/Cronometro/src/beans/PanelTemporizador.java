...
import interfaces.StopCronometo;
...
atrás
    ...
    private ArrayList<StopCronometo> listenersStopTemporizador;
    private ArrayList<StartCronometro> listenersStartTemporizador;
    ...
    // LISTENER
    public void addFinTemporizadorListener(StopCronometo listener) {
        this.listenersStopTemporizador.add(listener);
    }

    public void addInicioTemporizadorListener(StartCronometro listener) {
    ...
    private void jButtonStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStartActionPerformed
        ...
        this.running = true;
        for (StartCronometro listener : listenersStartTemporizador) {
        ...
        this.timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                if (running) {
                    ...
                    for (StopCronometo listener : listenersStopTemporizador) {
